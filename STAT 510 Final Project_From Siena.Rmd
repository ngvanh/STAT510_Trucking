...
# Read in data
trucking_df = read.delim("~/Library/Mobile Documents/com~apple~CloudDocs/Grad/STAT 510/Final Project/TRUCKING.txt", header = T)
```

```{r, echo = F, include = T}
head(trucking_df)

hist(trucking_df$PRICPTM)
```
...
hist(trucking_df$LNPRICE) # No transformation needed (already transformed to ln(Price))
